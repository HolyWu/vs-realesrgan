...
@custom_op("vsrealesrgan::upsample_nearest1d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_nearest1d")
...
@custom_op("vsrealesrgan::upsample_nearest2d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_nearest2d")
...
@custom_op("vsrealesrgan::upsample_nearest3d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_nearest3d")
...
@custom_op("vsrealesrgan::upsample_linear1d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_linear1d")
...
@custom_op("vsrealesrgan::upsample_bilinear2d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_bilinear2d")
...
@custom_op("vsrealesrgan::upsample_trilinear3d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_trilinear3d")
...
@custom_op("vsrealesrgan::upsample_bicubic2d", mutates_args=())
...
@register_fake("vsrealesrgan::upsample_bicubic2d")
...
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_nearest1d.default, supports_dynamic_shapes=True)
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_nearest2d.default, supports_dynamic_shapes=True)
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_nearest3d.default, supports_dynamic_shapes=True)
...
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_linear1d.default, supports_dynamic_shapes=True)
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_bilinear2d.default, supports_dynamic_shapes=True)
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_trilinear3d.default, supports_dynamic_shapes=True)
@enforce_tensor_types(
    {
        0: (TRTTensor,),
    }
...
@dynamo_tensorrt_converter(torch.ops.vsrealesrgan.upsample_bicubic2d.default, supports_dynamic_shapes=True)
@enforce_tensor_types(
    {
        0: (TRTTensor,),
    }
...
def interpolate(
    ...
    if input.dim() == 3 and mode == "nearest":
        return torch.ops.vsrealesrgan.upsample_nearest1d(input, output_size, scale_factors)
    if input.dim() == 4 and mode == "nearest":
        return torch.ops.vsrealesrgan.upsample_nearest2d(input, output_size, scale_factors)
    if input.dim() == 5 and mode == "nearest":
        return torch.ops.vsrealesrgan.upsample_nearest3d(input, output_size, scale_factors)
    ...
    if input.dim() == 3 and mode == "linear":
        ...
        return torch.ops.vsrealesrgan.upsample_linear1d(input, output_size, align_corners, scale_factors)
    if input.dim() == 4 and mode == "bilinear":
        ...
        return torch.ops.vsrealesrgan.upsample_bilinear2d(input, output_size, align_corners, scale_factors)
    if input.dim() == 5 and mode == "trilinear":
        assert align_corners is not None
        return torch.ops.vsrealesrgan.upsample_trilinear3d(input, output_size, align_corners, scale_factors)
    if input.dim() == 4 and mode == "bicubic":
        assert align_corners is not None
        if antialias:
            return torch._C._nn._upsample_bicubic2d_aa(input, output_size, align_corners, scale_factors)
        return torch.ops.vsrealesrgan.upsample_bicubic2d(input, output_size, align_corners, scale_factors)
